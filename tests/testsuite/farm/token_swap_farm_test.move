...
address alice = {{alice}};
script {
    use 0x49156896A605F092ba1862C50a9036c9::TokenMock::{Self, WETH, WBTC};
...
script {
    use 0x1::Account;
    use 0x49156896A605F092ba1862C50a9036c9::TokenMock::{WETH, WBTC};
...
script {
    use 0x1::Account;
    use 0x1::Math;
    use 0x49156896A605F092ba1862C50a9036c9::TokenMock::{Self, WBTC, WETH};
...
script {
    ...
    use 0x49156896A605F092ba1862C50a9036c9::TokenMock::{WBTC, WETH};
